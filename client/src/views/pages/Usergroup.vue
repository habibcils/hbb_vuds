<template>
    <div>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Users Group</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header"><h3>Data User Group</h3></div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="d-flex">
        ...
        <Modal :modal="modal" :closeModal="closeModal" :data="dataModal" @save="saveModal" :modeModal="modeModal" :userGroup="userGroup" />
    </div>
</template>
...
import Modal from '@/components/usergroup/Modal.vue'
