<template>
    <div>
        ...
        <Modal :modal="modal" :closeModal="closeModal" :data="dataModal" @save="saveModal" :modeModal="modeModal" :userGroup="userGroup" :title="titleModal"/>
    </div>
</template>
...
export default {
    ...
    data() {
        ...
        let columns = [
            ...
            {width: '10%', label: 'Group', name: 'group'},
    ...
    methods: {
        ...
        deleteUser(key){
            apiBase.post(this.prefixApi+'/deleteUser', { 'id': key }   )
                .then(response => {
